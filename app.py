...
pro_labore = st.sidebar.number_input("Pró-Labore / Custos Fixos (R$)", min_value=0.0, value=0.0, step=100.0)
...
with col2:
    ...
    st.metric("Payback Simples", f"{base['payback_simples']:.1f} meses" if base['payback_simples'] is not None else "Não atinge")
